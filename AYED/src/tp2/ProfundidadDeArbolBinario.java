	...
	private int sumatoria(BinaryTree<Integer> nodo, int p) {
	    ...
	    while (!cola.isEmpty() && nivelActual <= p) {
	        ...
	        if (visito != null) {
	        	...
	        	if (nivelActual == p ) sumaTotal = sumaTotal + visito.getData(); //Sumamos el nodo a nuestro acumulado
