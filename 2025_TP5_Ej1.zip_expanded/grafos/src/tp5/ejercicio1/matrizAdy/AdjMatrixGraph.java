...
public class AdjMatrixGraph<T> implements Graph<T> {
	...
	/**
	 * Conecta un vertice origen con su destino	 */
	...
	/**
	 * Conecta un vertice origen con su destino	indicando el peso */
    @Override
	...
	/**
	 * Desconecta un vértice origen con su destino	 */
    @Override
    ...
    //Retorna si el grafo está vacio
    @Override
    ...
    /*Retorna los adyacentes de un vértice*/
    @Override
