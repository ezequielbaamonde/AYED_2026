...
public class GraphTest {
	...
	public void setUp() throws Exception {
		grafo = new AdjMatrixGraph<Integer>(10); //Crea un grafo
		// Grafo inicial
		// (2)  <-->  (1)  --> (3)
	...
	public void testCreateAndRemoveVertex() {
		Graph<Integer> grafoVacio = new AdjMatrixGraph<>(10); //Nuevo grafo
		//assertEquals es una función de JUnit que se usa en los tests para verificar que
